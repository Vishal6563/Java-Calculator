...
class calculator1
{
    ...
    {
        Siddharthcalculator mobj=new Siddharthcalculator(400,400,"Siddharth");
    }
}

class Siddharthcalculator extends WindowAdapter implements ActionListener
{
    public Frame fobj;
    ...
    public Siddharthcalculator(int width,int height,String title)
    {
